<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="NewJob.aspx.cs" Inherits="Freelancer2.Admin.NewJob" %>
            ...
            <div class="container pt-4 pb-4">
                ...
                <div class="row-mr-lg-5 mb-lg-5 mb-3">
                    <div class="col md-6 pt-3">
                        ...
                        <asp:TextBox ID="txtJobTitle" runat="server" CssClass="form-control" placeholder="Ex.Web Developer,App Developer"
                ...
                <div class="row-mr-lg-5 mb-lg-5 mb-3">
                    <div class="col md-6 pt-3">
                        ...
                        <asp:TextBox ID="txtQualification" runat="server" CssClass="form-control" placeholder="Ex. MCA,Btech,MBA"
                            required></asp:TextBox>
                    </div>
                    <div class="col md-6 pt-3">
                        <label for="txtExperience" style="font-weight:600">Experience Required</label>
                        <asp:TextBox ID="txtExperience" runat="server" CssClass="form-control" placeholder="2 years,1.5 years.."
                            required></asp:TextBox>
                    </div>
                </div>
                <div class="row-mr-lg-5 mb-lg-5 mb-3">
                ...
                <div class="row-mr-lg-5 mb-lg-5 mb-3">
                    <div class="col md-6 pt-3">
                        ...
                        <asp:TextBox ID="txtSalary" runat="server" CssClass="form-control" placeholder="Ex: 5500/month,90000/year"
                          required></asp:TextBox>
                    </div>
                    <div class="col md-6 pt-3">
                ...
                <div class="row-mr-lg-5 mb-lg-5 mb-3">
                    <div class="col md-6 pt-3">
                        ...
                        <asp:TextBox ID="txtCompany" runat="server" CssClass="form-control" placeholder="Enter Company/Organisation Name"
                          required></asp:TextBox>
                    </div>
                    <div class="col md-6 pt-3">
