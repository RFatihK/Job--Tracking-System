<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="JobList.aspx.cs" Inherits="Freelancer2.Admin.JobList" %>
     ...
     <div style="background-image: url('../Images/bg.jpg');width: 100%;height:720px;background-repeat:no-repeat;
        background-size:cover; background-attachment:fixed;">
            <div class="container pt-4 pb-4">
                ...
                <div class="btn-toolbar justfy-content-between mb-3">
                       <div class="btn-group">
                           <asp:label ID="lblMsg"  runat="server"></asp:label>    
                       </div>
                                ...
                                <asp:TemplateField HeaderText="Edit">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnEditJob" runat="server" CommandName="EditJob"    
                                         ...
                                         <asp:Image ID="Img" runat="server" ImageUrl="../assets/img/icon/Job-List1.png" Height="25px" />
                                        </asp:LinkButton>
                                    </ItemTemplate>
