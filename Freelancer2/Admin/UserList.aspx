<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="UserList.aspx.cs" Inherits="Freelancer2.Admin.UserList" %>
                ...
                <div class="row mb-3 pt-sm-3">
                    <div class="col-md-12">
                        <asp:GridView Id="GridView1" runat="server" CssClass="table table-hover table-bordered" HeaderStyle-HorizontalAlign="Center"
                            ...
                            OnPageIndexChanging="GridView1_PageIndexChanging1" DataKeyNames="UserId" OnRowDeleting="GridView1_RowDeleting">
                            <Columns>
