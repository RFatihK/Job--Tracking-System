...
namespace Freelancer2.Admin
{
    public partial class JobList : System.Web.UI.Page
    {
        ...
        private void ShowJob()
        {
            ...
            query = @"Select Row_Number() over(Order by (Select 1)) as [Sr.No],JobId,Title,NoOfPost,Qualification,Experience,LastDateToApply,CompanyName,
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                if (r > 0)
                {
                    lblMsg.Text = "job deleted succesfully!";
