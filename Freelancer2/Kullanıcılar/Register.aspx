<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanıcılar/Site1.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Freelancer2.Kullanıcılar.Register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section>
        <div class="container pt-0-50 pb-40">
            <div class="row">
                <div class="col-12 pb-20">
                    <asp:Label ID="lblMsg" runat="server" Visible="false" placeholder="x"></asp:Label>
                </div>
                <div class="col-12">
                    <h2 class="contact-title text-center">Sign</h2>
                </div>
                <div class="col-lg-6 mx-auto">
                    <div class="form-contact contact_form">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtConfirmPassword" runat="server" CssClass="form-control" placeholder="Enter Confirm Password"
                                        TextMode="Password" required></asp:TextBox>
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Password and Confirm Password should be same." ControltoCompare="txtPassword" ControlToValidate="txtConfirmPassword"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Name must be characters"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlCountry" runat="server" DataSourceID="SqlDataSource1" CssClass="form-contact w-100" 
                                        AppendDataBoundItems="true" DataTextField="CountryName" DataValueField="CountryName"></asp:DropDownList>
                                        <asp:ListItem Value="0">Select Country</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator runat="server" ErrorMessage="Country is Required" ForeColor="Red"  Display="Dynamic" 
                                        SetFocusOnError="true" Font-Size="Small" ControlToValidate="ddlCountry" ></asp:RequiredFieldValidator>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <span class="clickLink"><a href="../Kullanıcılar/Login.aspx">Already Register? Click Here..</a></span>
                        </div>
                    </div>
                </div>
            </div>
